<template>
  <div>
    ...
    <div class="filtros" v-if="showFilter">
      <div class="row">
        <div class="col">
        ...
        <div class="col">
          <input
            type="search"
            v-model.trim="filters.nacionalidad"
  ...
  computed: {
    ...
    getUserFilter() {
      return this.users.filter((user) => {
        return (
          (this.filters.genero
            ? user.genero === this.filters.genero
            : user.genero.includes("")) &&
          user.edad <= this.filters.edad &&
          user.nacionalidad
            .toLowerCase()
            .includes(this.filters.nacionalidad.toLowerCase())
        );
      });
    },
  },
